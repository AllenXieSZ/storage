...
func TestMapDevices(t *testing.T) {
	...
	want := map[string]ebsDeviceInfo{
		"/dev/nvme1n1": {volumeID: "vol-0example111111111", mountPath: "/mysql/undo"},
		"/dev/nvme0n1": {volumeID: "vol-0example222222222", mountPath: notMounted},
		"/dev/nvme2n1": {volumeID: "vol-0example333333333", mountPath: notMounted},

#!/usr/bin/env python3
# OpenCart 阶梯并发压测：逐级提升并发，找拐点。直击 ALB（内网）或 CloudFront。
# 用法: BASE=http://alb-dns python3 loadtest_ramp.py [每线程迭代数] [并发阶梯,逗号分隔]
# 例:   BASE=http://alb-dns python3 loadtest_ramp.py 15 20,50,100,200,400
# 注意: Python threading+requests 受 GIL 限制, 单机发压能力弱, 适合"找拐点/编排"
#       而非"极限发压"。冲高 TPS 用 wrk。
import os, sys, time, random, threading, requests
from collections import defaultdict

BASE = os.environ.get("BASE", "http://your-alb-dns.us-east-2.elb.amazonaws.com")

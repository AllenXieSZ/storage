...
- Volumes (FlexVol, 512GB, StorageEfficiency off, Tiering NONE):
  - bkpvol   = fsvol-0b96244abc8fcb7bd  (junction /bkpvol)   → experiment: backed up once
  - cleanvol = fsvol-0ff9b92f659a38ed5  (junction /cleanvol) → control: never backed up
- FSx volume-level backup: backup-01aaa29249100f88b (of bkpvol) — AVAILABLE (~259s)
